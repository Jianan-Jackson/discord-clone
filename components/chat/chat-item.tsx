...
export const ChatItem = ({
    ...
    return (
        ...
        <div 
            className="relative group flex items-cneter hover:bg-black/5 p-4 transition w-full"
        >
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
...

                    {
                        isImage && (
                            <a
                                ...
                                overflow-hidden border flex items-cneter bg-secondary h-48 w-48"
                            >
                                <Image 
                                    src={fileUrl}
                                    alt={content}
...

                    {
                        !fileUrl && !isEditing && (
                            <p className={cn(
                                "text-[16px] text-zinc-600 dark:text-zinc-300",
                                deleted && "italic text-zinc-500 dark:text-zinc-400 text-xs mt-1"
                            )}>
                                {content}
                                {isUpdated && !deleted && (
                                    <span className="text-[12px] mx-2 text-zinc-500">
                                        (edited)
                                    </span>
                                )}
                            </p>
                                            ...
                                            <FormControl>
                                                <div className="relative w-full">
                                                    <Input
                                                        ...
                                                        dark:bg-zinc-700/75 boeder-none border-0
