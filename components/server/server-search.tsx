    ...
    return(
        <>
            <button 
                ...
                className="group px-2 py-2 grounded-md flex items-center gap-x-2 w-full
            ...
            >
                ...
                <kbd 
                    ...
                    gap-1 rounded border bg-muted px-1.5 font-momo text-[10px] font-medium
                        ...
                        return(
                            <CommandGroup key={label} heading={label}>
                                {data?.map(({id, icon, name}) => {
                                    return(
                                        <CommandItem key={id} onSelect={()=> onClick({
                                            id,
                                            type
                                        })}>
                                            {icon}
